...
```bash
wget -O /tmp/luci-theme-foxhound_v1.5.4.ipk https://github.com/fullband7/openwrt-theme-foxhound/releases/download/v1.5.4/luci-theme-foxhound_v1.5.4.ipk
opkg install /tmp/luci-theme-foxhound_v1.5.4.ipk
rm /tmp/luci-theme-foxhound_v1.5.4.ipk
...
```bash
wget -O /tmp/luci-theme-foxhound_v1.5.4.apk https://github.com/fullband7/openwrt-theme-foxhound/releases/download/v1.5.4/luci-theme-foxhound_v1.5.4.apk
apk add --allow-untrusted /tmp/luci-theme-foxhound_v1.5.4.apk
rm /tmp/luci-theme-foxhound_v1.5.4.apk
service rpcd restart
```
